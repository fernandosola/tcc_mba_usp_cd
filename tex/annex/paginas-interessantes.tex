\begin{description}
 ...
 \item[\url{https://github.com/fernandosola/tcc_mba_usp_cd/}] Projeto no GitHub contendo todo o código fonte implementado neste estudo.
 \item[\url{https://www.python.org/}] Página oficial da linguagem de programação Python;
 \item[\url{https://tika.apache.org/}] Página oficial do projeto Apache Tika.
