...
d) comparar a performance entre diferentes modelos encontrados utilizando dados reais.


\section{Estrutura do Documento}

O capítulo 1 apresenta uma breve introdução, objetivos e organização geral do trabalho. O capítulo 2 apresenta a revisão bibliográfica acerca de assuntos pertinentes ao trabalho e trabalhos similares. O capítulo 3 descreve a proposta do modelo e, ainda, discute sobre os testes e avaliação do modelo proposto. O capítulo 4 discute sobre os resultados, conclusões e trabalhos futuros.
