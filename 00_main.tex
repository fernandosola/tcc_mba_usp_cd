...
\tituloPT{Um modelo para classificação do grau de veracidade de denúncias: um estudo de caso com denúncias na CGU}
...
\curso{CCMC}
\data{20}{12}{2020} % Data do depósito
...
Em média, apenas 30\% das denúncias que chegam são consideradas aptas pelos especialistas da Ouvidoria. Uma quantidade enorme de esforço é gasta pela equipe em denúncias que não possuem o mínimo de informação para qualquer tipo de apuração. O volume de denúncias é um obstáculo que exige uma grande equipe trabalhando no processo de triagem. Esta pesquisa propõe a criação de um modelo de classificação que atribua o grau de risco de aptidão para uma denúncia permitindo direcionar melhor os esforços das equipes responsáveis pelo processo de triagem.
...
\input{02_revisao_bibliografica}

\chapter{Modelo Proposto}
\label{chapter:modelo_proposto}
\input{03_modelo_proposto}
