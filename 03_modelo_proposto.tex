...
A decisão sobre qual algoritmo utilizar para a geração do modelo foi tomada com base na comparação do score de acurácia balanceada obtido em diversos modelos testados. O processo consistiu basicamente em realizar as seguintes etapas para cada algoritmo a ser avaliado:
...
A \autoref{fig_00400_comparacao_score_modelos_dados_estr} apresenta um gráfico de \textit{boxplot} para cada algoritmo avaliado. A ordem em que os algoritmos aparecem foi definida pelo score obtido pela métrica \textit{balanced\_accuracy}.
