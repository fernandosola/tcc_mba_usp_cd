...
A mesma metodologia utilizada no modelo criado a partir de dado estruturados foi utilizada para a criação deste modelo. Assim, após a execução dos experimentos com os dados de treinamento tem-se os resultados apresentados na \autoref{}.
