...
\begin{figure}[h]
\centering
\caption{Quantidade de denúncias por rótulo}
\makebox[\columnwidth]{
\includegraphics[width=1.19\columnwidth]{images/fig_00100_quantidade_denuncias.png}
}
\label{fig:fig_00100_quantidade_denuncias}
\end{figure}
