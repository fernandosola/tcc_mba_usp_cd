...
A principal contribuição deste trabalho é a utilização de bases oficiais do governo federal para qualificar e ampliar informações de uma denúncia a partir de entidades nomeadas encontradas no corpo ou anexos de uma denúncia. A \autoref{tab_01000_visao_geral_dataset} apresenta uma visão comparativa para as soluções avaliadas.
